...
let isPointerTy g ty =
    ty |> stripTyEqns g |> (function 
        | TType_app(tcref, _) -> 
            tyconRefEq g g.nativeptr_tcr tcref ||
            tyconRefEq g g.voidptr_tcr tcref ||
            tyconRefEq g g.nativeint_tcr tcref ||
            tyconRefEq g g.unativeint_tcr tcref
        | _ -> false)
