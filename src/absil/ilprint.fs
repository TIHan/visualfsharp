...
and goutput_typ env os ty =
  ...
  | ILType.Value tspec when tspec.FullName = tname_SByte -> output_string os "int8"
  | ILType.Value tspec when tspec.FullName = tname_Int16 -> output_string os "int16"
  | ILType.Value tspec when tspec.FullName = tname_Int32 -> output_string os "int32"
  | ILType.Value tspec when tspec.FullName = tname_Int64 -> output_string os "int64"
  | ILType.Value tspec when tspec.FullName = tname_IntPtr -> output_string os "native int"
  | ILType.Value tspec when tspec.FullName = tname_Byte -> output_string os "unsigned int8"
  | ILType.Value tspec when tspec.FullName = tname_UInt16 -> output_string os "unsigned int16"
  | ILType.Value tspec when tspec.FullName = tname_UInt32 -> output_string os "unsigned int32"
  | ILType.Value tspec when tspec.FullName = tname_UInt64 -> output_string os "unsigned int64"
  | ILType.Value tspec when tspec.FullName = tname_UIntPtr -> output_string os "native unsigned int"
  | ILType.Value tspec when tspec.FullName = tname_Double -> output_string os "float64"
  | ILType.Value tspec when tspec.FullName = tname_Single -> output_string os "float32"
  | ILType.Value tspec when tspec.FullName = tname_Bool -> output_string os "bool"
  | ILType.Value tspec when tspec.FullName = tname_Char -> output_string os "char"
  | ILType.Value tspec ->
